...
if (isset($_POST["nuevoPersonaContratos"])) {
	...
	$nuevoPersonaContrato -> resolucion_ministerial = $_POST["nuevoResolucionMinisterial"];
...
if (isset($_POST["editarPersonaContrato"])) {
	...
	$editarPersonaContrato -> resolucion_ministerial = $_POST["editarResolucionMinisterial"];
