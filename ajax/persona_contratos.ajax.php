		...
		if ($this->id_contrato != 1) {
			...
			if ($this->recurrencia == 0) {
				...
				if ($this->tipo_contratacion == "SALUD") {
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>S E G U N D A</u>: (DEL OBJETO). - </strong>El presente Contrato a Plazo Fijo, tiene por objeto la prestaci&oacute;n de servicios del <strong>CONTRATADO (A) </strong>por <strong>Necesidad Extraordinaria de Servicios</strong><strong> de manera temporal, </span></strong>como '.$cargo['nombre_cargo'].' Nivel <strong>(</strong>'.$cargo['nivel_salarial'].'<strong>) </strong>con cargo a la Partida N&deg; 12100 (Personal eventual) del Programa 72 (Bienes y Servicios) en el/la ................<strong>.. </strong>ubicado en ................<strong>..</strong>, en cumplimiento a Memorandum Instructivo No. '.$memorandum['nro_memorandum'].' de fecha '.$memorandum['fecha_memorandum'].' de la Gerencia General.</span></p>
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>S E G U N D A</u>: (DEL OBJETO). - </strong>El presente Contrato a Plazo Fijo, tiene por objeto la prestaci&oacute;n de servicios del <strong>CONTRATADO (A) </strong>por <strong>Necesidad de Servicio</strong>, como '.$cargo['nombre_cargo'].' Nivel <strong>(</strong>'.$cargo['nivel_salarial'].'<strong>) </strong>con cargo a la Partida N&deg; 12100 (Personal eventual) del Programa 72 (Bienes y Servicios) en el/la ................<strong>.. </strong>, en cumplimiento a Memorandum Instructivo No. '.$memorandum['nro_memorandum'].' de fecha '.$memorandum['fecha_memorandum'].' emitido por la Gerencia General.</span></p>
