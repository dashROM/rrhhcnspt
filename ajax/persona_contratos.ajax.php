...
class AjaxPersonaContratos {
	...
	public function ajaxNuevoPersonaContrato()	{
		...
		$item = "puesto";
		$valor = "ADMINISTRADOR REGIONAL C.N.S.";
		...
		if ($this->id_contrato != 1) {
			...
			if ($this->recurrencia == 0) {
				...
				if (rtrim($this->tipo_contratacion) == "SALUD") {
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>D É C I M A&nbsp; T E R C E R A</u>: (DE LA CONFORMIDAD). - La Caja Nacional de Salud </strong>representada por el/la <strong style="font-size:10pt">'.$admin_regional['nombre_autoridad'].'</strong>.- <strong>Administrador Regional</strong>, <strong style="font-size:10pt">'.$servicios_grales['nombre_autoridad'].'</strong><strong>.- Jefe Servicios Generales</strong>, <strong style="font-size:10pt">'.$supervisor_admin['nombre_autoridad'].'</strong><strong>.- Supervisor Adm. I RR.HH.</strong>, as&iacute; como el/la Sr. (a). <strong style="font-size:10pt">'.$persona['nombre_persona'].' '.$persona['paterno_persona'].' '.$persona['materno_persona'].',</strong> damos nuestra conformidad con todas y cada una de las cl&aacute;usulas que anteceden en el presente contrato, oblig&aacute;ndonos a su fiel cumplimiento, firmando en se&ntilde;al de conformidad en cinco ejemplares del mismo tenor.</span></p>
				...
				if (rtrim($this->tipo_contratacion) == "SALUD") {
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>D É C I M A&nbsp; P R I M E R A</u>: (DE LA CONFORMIDAD). - La Caja Nacional de Salud </strong>representada por el/la <strong style="font-size:10pt">'.$admin_regional['nombre_autoridad'].'</strong>.- <strong>Administrador Regional</strong>, <strong style="font-size:10pt">'.$servicios_grales['nombre_autoridad'].'</strong><strong>.- Jefe Servicios Generales</strong>, <strong style="font-size:10pt">'.$supervisor_admin['nombre_autoridad'].'</strong><strong>.- Supervisor Adm. I RR.HH.</strong>, as&iacute; como el/la Sr. (a). <strong style="font-size:10pt">'.$persona['nombre_persona'].' '.$persona['paterno_persona'].' '.$persona['materno_persona'].',</strong> damos nuestra conformidad con todas y cada una de las cl&aacute;usulas que anteceden en el presente contrato, oblig&aacute;ndonos a su fiel cumplimiento, firmando en se&ntilde;al de conformidad en cinco ejemplares del mismo tenor.</span></p>
