...
class MYPDF extends TCPDF {
    ...
    public function Footer() {
        ...
        // Page number
        $this->Cell(390, 10, $this->getAliasNumPage(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
    }
}
...
class AjaxPersonaContratos {
	...
	public $id_cargo;
	public $id_contrato;
	public $asignacion_persona_contrato;
	public $id_suplencia;
	...
	public function ajaxNuevoPersonaContrato()	{
		...
		$servicios_grales = ControladorAutoridades::ctrMostrarAutoridades($item, $valor);
		...
		if ($this->id_contrato != 1) {
			...
			if ($this->recurrencia == 0) {
				...
				if (rtrim($this->tipo_contratacion) == "SALUD") {
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>P R I M E R A</u>: (DE LAS PARTES). -</strong> Intervienen en la suscripción del presente Contrato de Trabajo a Plazo Fijo, por una parte, la <strong style="font-size:10pt">'.$admin_regional['nombre_autoridad'].'</strong>, en su condición de <strong>Administrador Regional Potosí</strong> de la Caja Nacional de Salud, en mérito a Poder especial testimonio Nro 284/2021 de 14/09/2021 y el/la <strong style="font-size:10pt">'.$jefe_medico['nombre_autoridad'].'</strong><strong> Jefe Médico Regional</strong>, <strong style="font-size:10pt">'.$supervisor_admin['nombre_autoridad'].'</strong><strong> Supervisor Adm. I RR.HH.</strong>, quienes en adelante se denominan <strong>&quot;LA CAJA&quot;</strong>; y por la otra, el/la Sr.(a). <strong style="font-size:10pt">'.$persona['nombre_persona'].' '.$persona['paterno_persona'].' '.$persona['materno_persona'].'</strong> quien es mayor de edad, h&aacute;bil por derecho, con <strong>C.I. N&ordm;</strong><strong style="font-size:10pt"> '.$persona['ci_persona'].',</strong> estado civil <strong style="font-size:10pt">'.$persona['estado_civil'].'</strong> domiciliado(a) en <strong style="font-size:10pt">'.$persona['direccion_persona'].'</strong>, con número de celular <strong style="font-size:10pt">'.$persona['telefono_persona'].'</strong>, que en adelante se denominar&aacute; el <strong>&quot;CONTRATADO(A)&quot;</strong>.</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>S E G U N D A</u>: (DEL OBJETO). -</strong> El presente Contrato a Plazo Fijo, tiene por objeto la prestaci&oacute;n de servicios del <strong>CONTRATADO (A) </strong>por <strong>Necesidad Extraordinaria de Servicios</strong><strong> de manera temporal, </span></strong>como <strong style="font-size:10pt">'.$cargo['nombre_cargo'].'</strong> Nivel <strong style="font-size:10pt">('.$cargo['nivel_salarial'].')</strong> con cargo a la Partida N&deg; 12100 (Personal eventual) del Programa 72 (Bienes y Servicios) en el <strong style="font-size:10pt">'.$establecimiento['nombre_establecimiento'].'</strong> ubicado en <strong style="font-size:10pt">'.$establecimiento['ubicacion_establecimiento'].'</strong>, en cumplimiento al Circular Instructivo No. <strong style="font-size:10pt">'.$memorandum['nro_memorandum'].'</strong> de fecha <strong style="font-size:10pt">'.date("d/m/Y", strtotime($memorandum['fecha_memorandum'])).'</strong> de la Gerencia General.</span></p>
					...
					<ul>
						<li style="text-align:justify"><span style="font-size:10pt">Requerimiento de Contratación emitido por la Unidad Solicitante.</span></li>
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>D É C I M
</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>S E G U N D A</u>: (DEL OBJETO). -</strong> El presente Contrato a Plazo Fijo, tiene por objeto la prestaci&oacute;n de servicios del <strong>CONTRATADO (A) </strong>por <strong>Necesidad extraordinaria de Servicio de manera temporal</strong>, como <strong style="font-size:10pt">'.$cargo['nombre_cargo'].'</strong> Nivel <strong style="font-size:10pt">('.$cargo['nivel_salarial'].')</strong> con cargo a la Partida N&deg; 12100 (Personal eventual) del Programa 72 (Bienes y Servicios) en el <strong style="font-size:10pt">'.$establecimiento['nombre_establecimiento'].'</strong>, en cumplimiento a Memorandum Instructivo No. <strong style="font-size:10pt">'.$memorandum['nro_memorandum'].'</strong> de fecha <strong style="font-size:10pt">'.date("d/m/Y", strtotime($memorandum['fecha_memorandum'])).'</strong> emitido por la Gerencia General.</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt">Cumpliendo para este fin, lo se&ntilde;alado en la Resoluci&oacute;n Administrativa N&deg; 650/07 de fecha 27/04/2007 emitida por el Viceministerio de Trabajo, Desarrollo Laboral y Cooperativas &ndash; Ministerio de Trabajo, Empleo y Previsi&oacute;n Social, en su art&iacute;culo 1, Numeral 2 inc. b), que a la letra se&ntilde;ala: <em>&ldquo;Las tareas por cierto tiempo por necesidades de temporada (Art. 3&deg; del D.L. 16187) exigencias circunstanciales del mercado, demanda extraordinaria de productos o servicios, que requieran contrataci&oacute;n adicional de trabajadores.&rdquo;&nbsp;&nbsp;&nbsp; </em></span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>T E R C E R A</u>: (DE LA VIGENCIA). -</strong> El presente Contrato tendr&aacute; vigencia a partir del <strong style="font-size:10pt">'.date("d/m/Y", strtotime($this->inicio_contrato)).' </strong>hasta el <strong style="font-size:10pt">'.date("d/m/Y", strtotime($this->fin_contrato)).'</strong>, indefectiblemente</span></p>
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>D É C I M A&nbsp; S E G U N D A</u>: (INSCRIPCI&Oacute;N DE HEREDEROS). &ndash; </strong>El Contratado en cumplimiento del inc. h) del art. 7 del Reglamento de la Ley General del Trabajo, registra como herederos (as) a:</span></p>
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>D É C I M A&nbsp; T E R C E R A</u>: (DE LA CONFORMIDAD). - La Caja Nacional de Salud </strong>representada por la <strong style="font-size:10pt">'.$admin_regional['nombre_autoridad'].'</strong>.- <strong>Administrador Regional</strong>, <strong style="font-size:10pt">'.$servicios_grales['nombre_autoridad'].'</strong><strong>.- Jefe Servicios Generales</strong>, <strong style="font-size:10pt">'.$supervisor_admin['nombre_autoridad'].'</strong><strong>.- Supervisor Adm. I RR.HH.</strong>, as&iacute; como el/la Sr. (a). <strong style="font-size:10pt">'.$persona['nombre_persona'].' '.$persona['paterno_persona'].' '.$persona['materno_persona'].',</strong> damos nuestra conformidad con todas y cada una de las cl&aacute;usulas que anteceden en el presente contrato, oblig&aacute;ndonos a su fiel cumplimiento, firmando en se&ntilde;al de conformidad en cinco ejemplares del mismo tenor.</span></p>
				...
				if (rtrim($this->tipo_contratacion) == "SALUD") {
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>P R I M E R A</u>: (DE LAS PARTES). -</strong> Intervienen en la suscripci&oacute;n del presente Contrato de Trabajo a Plazo Fijo, por una parte, el/la <strong style="font-size:10pt">'.$admin_regional['nombre_autoridad'].'</strong>, en su condici&oacute;n de <strong>Administrador Regional</strong> de la Caja Nacional de Salud, en m&eacute;rito a Poder especial testimonio Nro 284/2021 de 14/09/2021 y el/la <strong style="font-size:10pt">'.$jefe_medico['nombre_autoridad'].'</strong><strong> Jefe Médico Regional</strong>, quienes en adelante se denominan <strong>&quot;LA CAJA&quot;</strong>; y por la otra, el/la Sr.(a). <strong style="font-size:10pt">'.$persona['nombre_persona'].' '.$persona['paterno_persona'].' '.$persona['materno_persona'].'</strong> quien es mayor de edad, h&aacute;bil por derecho, con <strong>C.I. N&ordm;</strong> <strong style="font-size:10pt">'.$persona['ci_persona'].'</strong>, estado civil <strong style="font-size:10pt">'.$persona['estado_civil'].'</strong> domiciliado(a) en <strong style="font-size:10pt">'.$persona['direccion_persona'].'</strong>, que en adelante se denominar&aacute; el <strong>&quot;CONTRATADO(A)&quot;</strong> con nro de celular <strong style="font-size:10pt">'.$persona['telefono_persona'].'</strong>.</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>S E G U N D A</u>: (DEL OBJETO). -</strong> El presente Contrato de Trabajo a Plazo Fijo, tiene por objeto la prestaci&oacute;n de servicios del <strong>CONTRATADO (A) </strong>por <strong>Necesidad de Servicio</strong>, como <strong style="font-size:10pt">'.$cargo['nombre_cargo'].'</strong> Nivel <strong style="font-size:10pt">('.$cargo['nivel_salarial'].')</strong> con cargo a la Partida N&deg; 12100 (Personal eventual) del Programa 72 (Bienes y Servicios) en el/la <strong style="font-size:10pt">'.$establecimiento['nombre_establecimiento'].'</strong>. ubicado en <strong style="font-size:10pt">'.$establecimiento['ubicacion_establecimiento'].'</strong>.</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>T E R C E R A</u>: (DE LA VIGENCIA). -</strong> El presente Contrato de Trabajo a Plazo Fijo tendr&aacute; vigencia a partir del <strong style="font-size:10pt">'.date("d/m/Y", strtotime($this->inicio_contrato)).' </strong>hasta el <strong style="font-size:10pt">'.date("d/m/Y", strtotime($this->fin_contrato)).'</strong>.</span></p>

					<p style="text-align:justify"><span style="font-size:10pt"><strong><u>C U A R T A</u>: (DEL SALARIO).- </strong>De acuerdo a Resoluci&oacute;n de Directorio No. 095/2019 de fecha 04/07/2019 en la cual aprueba la nueva Escala Salarial del Personal Eventual de la C.N.S., expresada en el cuadro de equivalencia considerando la Escala Salarial Gesti&oacute;n 2019, aprobada con Resoluci&oacute;n Ministerial N&deg; 443 de fecha 22/05/2019 del Ministerio de Econom&iacute;a y Finanzas Publicas, Par. I Art. 46 y Par. II Art. 48 de la Constituci&oacute;n Pol&iacute;tica del Estado, el salario que percibir&aacute; el <strong>CONTRATADO (A) </strong>est&aacute; sujeto a la previsi&oacute;n presupuestaria establecida; correspondiendo a <strong style="font-size:10pt">Bs. '.number_format($cargo['haber_basico'], 2, ",", ".").'</strong><strong style="font-size:10pt"> ('.$haber_literal.'),</strong> mensuales conforme al nivel y cargo para el que fue contratado, seg&uacute;n presupuesto.</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10p
</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt">Tambi&eacute;n se considerar&aacute; causal de rescisi&oacute;n de Contrato de Trabajo a Plazo Fijo, al cumplimiento de la vigencia establecida en la cl&aacute;usula tercera, as&iacute; como la renuncia previa aceptaci&oacute;n de la M&aacute;xima Autoridad Ejecutiva, para cuyo efecto el <strong>CONTRATADO (A)</strong> deber&aacute; comunicar su intenci&oacute;n a <strong>LA CAJA</strong> con (15) d&iacute;as de anticipaci&oacute;n de acuerdo a determinaciones institucionales.</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt">A la rescisi&oacute;n de Contrato de Trabajo a Plazo Fijo, el <strong>CONTRATADO (A)</strong> tiene la obligaci&oacute;n de entregar el trabajo pendiente a satisfacci&oacute;n y los activos fijos asignados, de conformidad al Art. 32 del D.S.26115 de 16 de mayo de 2001.</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>D É C I M A</u>: (INSCRIPCI&Oacute;N DE HEREDEROS). -</strong> El Contratado en cumplimiento del inc. h) del art. 7 del Reglamento de la Ley General del Trabajo, registra como herederos (as) a:</span></p>
					...
					for ($i = 0; $i < count($persona_herederos); $i++) { 
						...
						$documento_contrato .= '
							<tr>
								<td>'.$persona_herederos[$i]["nombre_completo"].'</td>
								<td align="center">-</td>
								<td align="center">'.$persona_herederos[$i]["parentezco"].'</td>
							</tr>';
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>P R I M E R A</u>: (DE LAS PARTES). -</strong> Intervienen en la suscripci&oacute;n del presente Contrato de Trabajo a Plazo Fijo, por una parte, el/la <strong style="font-size:10pt">'.$admin_regional['nombre_autoridad'].'</strong>, en su condici&oacute;n de <strong>Administrador Regional</strong> de la Caja Nacional de Salud, en m&eacute;rito a Poder especial testimonio Nro 284/2021 de 14/09/2021 y el/la <strong style="font-size:10pt">'.$supervisor_admin['nombre_autoridad'].'</strong><strong> Encargado de Recursos Humanos</strong>, quienes en adelante se denominan <strong>&quot;LA CAJA&quot;</strong>; y por la otra, el/la Sr.(a). <strong style="font-size:10pt">'.$persona['nombre_persona'].' '.$persona['paterno_persona'].' '.$persona['materno_persona'].'</strong> quien es mayor de edad, h&aacute;bil por derecho, con <strong>C.I. N&ordm;</strong> <strong style="font-size:10pt">'.$persona['ci_persona'].'</strong>, estado civil <strong style="font-size:10pt">'.$persona['estado_civil'].'</strong> domiciliado(a) en <strong style="font-size:10pt">'.$persona['direccion_persona'].'</strong>, que en adelante se denominar&aacute; el <strong>&quot;CONTRATADO(A)&quot;</strong> con nro de celular <strong style="font-size:10pt">'.$persona['telefono_persona'].'</strong>.</span></p>

					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>S E G U N D A</u>: (DEL OBJETO). -</strong> El presente Contrato de Trabajo a Plazo Fijo, tiene por objeto la prestaci&oacute;n de servicios del <strong>CONTRATADO (A) </strong>por <strong>Necesidad de Servicio</strong>, como <strong style="font-size:10pt">'.$cargo['nombre_cargo'].'</strong> Nivel <strong style="font-size:10pt">('.$cargo['nivel_salarial'].')</strong> con cargo a la Partida N&deg; 12100 (Personal eventual) del Programa 72 (Bienes y Servicios) en el/la <strong style="font-size:10pt">'.$establecimiento['nombre_establecimiento'].'</strong>.</span></p>
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>D É C I M A&nbsp; P R I M E R A</u>: (DE LA CONFORMIDAD). - La Caja Nacional de Salud </strong>representada por la <strong style="font-size:10pt">'.$admin_regional['nombre_autoridad'].'</strong>.- <strong>Administrador Regional</strong>, <strong style="font-size:10pt">'.$servicios_grales['nombre_autoridad'].'</strong><strong>.- Jefe Servicios Generales</strong>, <strong style="font-size:10pt">'.$supervisor_admin['nombre_autoridad'].'</strong><strong>.- Supervisor Adm. I RR.HH.</strong>, as&iacute; como el/la Sr. (a). <strong style="font-size:10pt">'.$persona['nombre_persona'].' '.$persona['paterno_persona'].' '.$persona['materno_persona'].',</strong> damos nuestra conformidad con todas y cada una de las cl&aacute;usulas que anteceden en el presente contrato, oblig&aacute;ndonos a su fiel cumplimiento, firmando en se&ntilde;al de conformidad en cinco ejemplares del mismo tenor.</span></p>
		...
		$datos = array(	"id_lugar" 	 			 		=> $this->id_lugar,
				        ...
				        "asignacion_persona_contrato"  	=> $this->asignacion_persona_contrato,
		...
		if ($this->id_contrato != 1) {
			...
			if ($this->recurrencia == 0) {
				...
				if (rtrim($this->tipo_contratacion) == "SALUD") {
					...
					<p style="margin-right:2px; text-align:justify"><span style="font-size:10pt"><strong><u>P R I M E R A</u>: (DE LAS PARTES). -</strong> Intervienen en la suscripci&oacute;n del presente Contrato de Trabajo a Plazo Fijo, por una parte, la <strong style="font-size:10pt">'.$admin_regional['nombre_autoridad'].'</strong>, en su condici&oacute;n de <strong>Administrador Regional</strong> de la Caja Nacional de Salud, en m&eacute;rito a Poder especial testimonio Nro 284/2021 de 14/09/2021 y el/la <strong style="font-size:10pt">'.$jefe_medico['nombre_autoridad'].'</strong><strong> Jefe Médico Regional</strong>, quienes en adelante se denominan <strong>&quot;LA CAJA&quot;</strong>; y por la otra, el/la Sr.(a). <strong style="font-size:10pt">'.$persona['nombre_persona'].' '.$persona['paterno_persona'].' '.$persona['materno_persona'].'</strong> quien es mayor de edad, h&aacute;bil por derecho, con <strong>C.I. N&ordm;</strong> <strong style="font-size:10pt">'.$persona['ci_persona'].'</strong>, estado civil <strong style="font-size:10pt">'.$persona['estado_civil'].'</strong> domiciliado(a) en <strong style="font-size:10pt">'.$persona['direccion_persona'].'</strong>, que en adelante se denominar&aacute; el <strong>&quot;CONTRATADO(A)&quot;</strong> con nro de celular <strong style="font-size:10pt">'.$persona['telefono_persona'].'</strong>.</span></p>
	...
	public function ajaxMostrarDocumentoContratoPDF()	{
		...
		$pdf->fin_contrato = $respuesta['fin_contrato'];
...
if (isset($_POST["nuevoPersonaContratos"])) {
	...
	if (isset($_POST["nuevoAsigPersonaContrato"])) {

		$nuevoPersonaContrato -> asignacion_persona_contrato = $_POST["nuevoAsigPersonaContrato"];

	} else {

		$nuevoPersonaContrato -> asignacion_persona_contrato = null;
...
if (isset($_POST["editarPersonaContrato"])) {
	...
	$editarPersonaContrato -> tipo_contratacion = $_POST["editarTipoContratacion"];
	...
	if (isset($_POST["editarAsigPersonaContrato"])) {

		$editarPersonaContrato -> asignacion_persona_contrato = $_POST["editarAsigPersonaContrato"];

	} else {

		$editarPersonaContrato -> asignacion_persona_contrato = null;
