...
class ModeloPersonaContratos {
	...
	static public function mdlNuevoPersonaContrato($tabla, $datos){
		...
		$stmt = Conexion::conectarPG()->prepare("INSERT INTO $tabla(id_lugar, id_establecimiento, id_persona, id_cargo, inicio_contrato, dias_contrato, fin_contrato, id_contrato, id_suplencia, id_memorandum, estado_contrato, observaciones_contrato, documento_contrato, nro_cod_contrato, cod_contrato, tipo_contratacion, ampliacion, recurrencia, certificacion_presupuestaria) VALUES (:id_lugar, :id_establecimiento, :id_persona, :id_cargo, :inicio_contrato, :dias_contrato, :fin_contrato, :id_contrato, :id_suplencia, :id_memorandum, :estado_contrato, :observaciones_contrato, :documento_contrato, :nro_cod_contrato, :cod_contrato, :tipo_contratacion, :ampliacion, :recurrencia, :certificacion_presupuestaria)");
