...
$bloque2 = <<<EOF
	...
	<table style="font-size: 10px; padding: 5px 10px">
		...
		<tr>
			...
			<td style="border: 1px solid #666; backgroun-color: white; width: 390px">
				Cliente: $respuestaCliente[nombre]
			</td>

			<td style="border: 1px solid #666; backgroun-color: white; width: 150px; text-align: right">
				fecha: $fecha
			</td>
